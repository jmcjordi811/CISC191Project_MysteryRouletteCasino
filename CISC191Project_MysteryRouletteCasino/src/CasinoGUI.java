...
//                321, 302, 281, 260, 239, 218, 199, 182, 168, 156, 148, 142};
    ...
    private static ImageIcon img1 = new ImageIcon("/Users/jordi.j.mejiacruz/eclipse-workspace/CISC191Project_MysteryRouletteCasino/src/Roulette_Imgs/Roulette.png");
    private static ImageIcon img2 = new ImageIcon("/Users/jordi.j.mejiacruz/eclipse-workspace/CISC191Project_MysteryRouletteCasino/src/Roulette_Imgs/BettingTable.png");
    private static ImageIcon img3 = new ImageIcon("/Users/jordi.j.mejiacruz/eclipse-workspace/CISC191Project_MysteryRouletteCasino/src/Roulette_Imgs/MysteryRouletteCards/BackCardTemplate.png");
		...
		public void actionPerformed(ActionEvent e) {
			try {
				if(rotation == 15 && position[index] == wheelLandsOn.getNumber()){
					...
					if(card == 1){
						timer.restart();
						ImageIcon img4 = new ImageIcon("/Users/jordi.j.mejiacruz/eclipse-workspace/CISC191Project_MysteryRouletteCasino/src/Roulette_Imgs/MysteryRouletteCards/FrontCard_" + win.getNumber() + ".png");
						card1.setIcon(img4);
